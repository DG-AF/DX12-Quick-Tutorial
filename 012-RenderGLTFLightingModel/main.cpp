...
private:
	...
	struct Material
	{
		...
		XMFLOAT4 DiffuseAlbedoLight;	// 贴图的反照率分量，表示贴图对光的反射能力
		XMFLOAT4 SpecularLight;			// 贴图反射高光部分的颜色
...
public:
	...
	void UpdateConstantBuffer()
	{
		...
		// 每帧更新光线方向之前，对光线按世界空间下的 y 轴进行旋转
		// XMVector3Transform 将向量与矩阵相乘 (前三个分量)，实现向量的各种变换
		m_GlobalLight.LightDirection = 
			XMVector3Transform(m_GlobalLight.LightDirection, XMMatrixRotationY(0.02 * XM_PIDIV2));
