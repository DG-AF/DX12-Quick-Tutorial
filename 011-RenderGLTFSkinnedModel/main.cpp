...
// (11) RenderGLTFSkinnedModel: 使用 DirectX 12 + Assimp 渲染《约会大作战》中的 时崎狂三 gltf 骨骼模型
...
private:
	...
	std::string ModelFileName = "kurumi/scene.gltf";				// 模型文件名
	std::string ModelTextureFilePath = "kurumi/";					// 模型所在文件夹
...
public:
	...
	void STEP1_InitWindow(HINSTANCE hins)
	{
		...
		// 使用上文的窗口类创建窗口
		m_hwnd = CreateWindow(wc.lpszClassName, L"时崎狂三", WS_SYSMENU | WS_OVERLAPPED,
